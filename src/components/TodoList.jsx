...
/**
 * Renders the sort control, the list of todo cards, and the empty state.
 */
function TodoList({ todos, sortBy, onSortChange, onToggleComplete, onEdit, onDelete, onResetAll }) {
      ...
      <div className="todo-list-header">
        ...
        {todos.length > 0 && (
          <div className="todo-list-controls">
            ...
            <button className="btn btn-sm btn-danger-outline" onClick={onResetAll}>
              Reset All
            </button>
          </div>
        )}
